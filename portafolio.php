	...
	<div class="row">
		...
		<div class="flex">
			...
			<div class="panelFlexLarge btnB">
				...
				<a class="btn-red btnC <?php echo (!$user) ? '' : 'request_demo'; ?>" href="javascript:void(0)" <?php echo (!$user) ? 'data-toggle="modal" data-target="#registroModal"' : '' ?> data-name="Desarrollo de nuevos productos ">SOLICITAR DEMO</a>
			</div>
			<!--  MÓDULO -->
			...
			<div class="panelFlexLarge btnB">
				...
				<a class="btn-red btnC <?php echo (!$user) ? '' : 'request_demo'; ?>" href="javascript:void(0)" <?php echo (!$user) ? 'data-toggle="modal" data-target="#registroModal"' : '' ?> data-name="Diseño de nuevos productos">SOLICITAR DEMO</a>
			</div>
			<!--  MÓDULO -->
			...
			<div class="panelFlexLarge btnB">
				...
				<a class="btn-red btnC <?php echo (!$user) ? '' : 'request_demo'; ?>" href="javascript:void(0)" <?php echo (!$user) ? 'data-toggle="modal" data-target="#registroModal"' : '' ?> data-name="Mecánico">SOLICITAR DEMO</a>
			</div>
			<!--  MÓDULO -->
			...
			<div class="panelFlexLarge btnB">
				...
				<a class="btn-red btnC <?php echo (!$user) ? '' : 'request_demo'; ?>" href="javascript:void(0)" <?php echo (!$user) ? 'data-toggle="modal" data-target="#registroModal"' : '' ?> data-name="Diseño Eléctrico">SOLICITAR DEMO</a>
			</div>
			<!--  MÓDULO -->
			...
			<div class="panelFlexLarge btnB">
				...
				<a class="btn-red btnC <?php echo (!$user) ? '' : 'request_demo'; ?>" href="javascript:void(0)" <?php echo (!$user) ? 'data-toggle="modal" data-target="#registroModal"' : '' ?> data-name="Validación">SOLICITAR DEMO</a>
			</div>
			<!--  MÓDULO -->
			...
			<div class="panelFlexLarge btnB">
				...
				<a class="btn-red btnC <?php echo (!$user) ? '' : 'request_demo'; ?>" href="javascript:void(0)" <?php echo (!$user) ? 'data-toggle="modal" data-target="#registroModal"' : '' ?> data-name="Administración">SOLICITAR DEMO</a>
			</div>
			<!--  MÓDULO -->
			...
			<div class="panelFlexLarge btnB">
				...
				<a class="btn-red btnC <?php echo (!$user) ? '' : 'request_demo'; ?>" href="javascript:void(0)" <?php echo (!$user) ? 'data-toggle="modal" data-target="#registroModal"' : '' ?> data-name="Colaboración"> SOLICITAR DEMO</a>
			</div>
			<!--  MÓDULO -->
			...
			<div class="panelFlexLarge btnB">
				...
				<a class="btn-red btnC <?php echo (!$user) ? '' : 'request_demo'; ?>" href="javascript:void(0)" <?php echo (!$user) ? 'data-toggle="modal" data-target="#registroModal"' : '' ?> data-name="Manufactura"> SOLICITAR DEMO</a>
			</div>
			<!--  MÓDULO -->
		</div> 
		<!--flex-->
